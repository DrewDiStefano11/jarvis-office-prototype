...
const mockFloor: FloorDefinition = {
    ...
    departments: [{ id: mockDepartmentId, floorId: mockFloorId, number: 1, name: 'Studio', accessLevel: 'general', visual: { label: 'Studio', palette: 'mock', visualVariant: 'mock-department' } }],
